...
\State $\bm C = \sum_{i=1}^n |\bm{\Rho}_{ij}|, \forall j=1,\ldots,m$ \Comment{Sum rows of the correlation matrix}
...
{} & {\,\,} \xi_I \geq 0,\, \forall I \in \set{1,\ldots,n}, & {} & 0 \leq \alpha_I \leq C,\, \forall I \in \set{1,\ldots,n},  \\[8pt]
...
\begin{equation*}
\min\limits_{\bm (\bm{w},b) \in \mathcal{H}_o \times \reals} R {\,\,} = {\,\,} \frac{1}{2}||\bm{w}||^2 + C L(y_j,\, o_{(w,b)}(\bm{x}_j)).
\end{equation*}
