...
\If{$yo \leq 1$}
\State $\lambda \leftarrow \eta\,C\,Y_i$
\State $\alpha_i \leftarrow \alpha_i + \lambda$
\State $b \leftarrow b + \lambda\,\beta$
\State $\bm I_{nsv} \leftarrow i$
\State $nsv \leftarrow nsv + 1$
\EndIf
