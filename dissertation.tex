...
\textit{The success of OLLAWV for traditional classification, as well as its online nature, inspired its implementation under the data stream setting.}
...
• Inmanycases,theentirestreammaynotbeavailableatasingleprocessororlocation.Insuch cases, distributed mining of data streams becomes extremely important.
...
The classification performance was measured using 2 metrics: Accuracy and Cohen’s kappa rate, and the results are shown in Tables~\ref{tab:DSResultsacc} and~\ref{tab:DSResultskappa} respectively. The metrics are calculated as shown in Equations~\ref{eq:accuracyds} and~\ref{eq:kappads}, where TP is the true positive value, TN is the true negative value, FP is the false positive value, and FN is the false negative value.
\begin{subequations}
\label{eq:metricsds}
\begin{align}
...
\end{align}
\end{subequations}
The training and testing times of each algorithm are also given in Tables~\ref{tab:DSResultsTrain} and~\ref{tab:DSResultsTestTime} to analyze the scalability and speed of each of the algorithms. These metrics were all recorded using the Test-Then-Train procedure. 
...
\fill[fill=gray,fill opacity=0.5] (2.7188,-0.1) rectangle (5.5078,0.1);
...
\begin{table}[t!]
\caption{Testing Time (seconds) Comparison for Data Stream Classifiers}
\scriptsize
\centering
\label{tab:DSResultsTestTime}
\resizebox{\textwidth}{!}{\begin{tabularx}{1.5\textwidth}{l@{\extracolsep{\fill}}ccccccccccccccc}
\noalign{\smallskip}\hline\noalign{\smallskip}
Dataset & OLLAWV & HT & AdaHT & Naive Bayes & $k$NNPAW &SCD & RC &RCNB & SAE2 & LearnNSE &DWM &DACC &OCBoost &\\
\noalign{\smallskip}\hline\noalign{\smallskip}
CovType &0.0391 &0.0256 &0.0321 &0.0089 &1.3744 &0.0041 &\textbf{0.0010} &0.0304 &0.0493 &0.1896 &0.0358 &0.0170 &0.0325 &  \\
census &0.2235 &0.0082 &0.0095 &0.0033 &2.2826 &0.0014 &\textbf{0.0012} &0.0082 &0.0048 &0.1052 &0.0125 &0.0076 &0.0099 &  \\
shuttle &0.0072 &0.0054 &0.0060 &0.0051 &0.3265 &0.0017 &\textbf{0.0012} &0.0105 &0.0092 &0.1228 &0.0096 &0.0108 &0.0176 &  \\
RBFNoDrift &0.0372 &0.0051 &0.0065 &0.0016 &0.4792 &\textbf{0.0014} &0.0196 &0.0180 &0.0168 &0.0322 &0.0084 &0.0021 &0.0102 &  \\
LEDNoDrift &0.0927 &0.0014 &0.0021 &0.0027 &1.6070 &0.0018 &\textbf{0.0010} &0.0190 &0.0302 &0.0603 &0.0148 &0.0050 &0.0105 &  \\
HyperplaneSlow &0.0407 &0.0029 &0.0038 &0.0016 &0.5687 &0.0020 &\textbf{0.0004} &0.0048 &0.0220 &0.0814 &0.0080 &0.0037 &0.0095 &  \\
HyperplaneFaster &0.0273 &0.0088 &0.0113 &0.0019 &0.5691 &\textbf{0.0016} &0.0020 &0.0051 &0.0164 &0.0794 &0.0085 &0.0038 &0.0083 &  \\
RBFGradualRecurring &0.0436 &0.0141 &0.0154 &0.0060 &0.7791 &\textbf{0.0040} &0.0067 &0.0171 &0.0485 &0.2963 &0.0301 &0.0103 &0.0448 &  \\
RBFBlips &0.0370 &0.0106 &0.0127 &0.0061 &0.7407 &\textbf{0.0032} &0.0039 &0.0148 &0.0464 &0.5582 &0.0312 &0.0133 &0.0457 &  \\
WaveformGenerator &0.0604 &0.0231 &0.0291 &0.0094 &2.4650 &0.0053 &\textbf{0.0033} &0.0207 &0.0671 &0.3095 &0.0454 &0.0142 &0.0400 &  \\
STAGGERGeneratorF1 &0.0018 &\textbf{0.0002} &0.0003 &\textbf{0.0002} &0.1834 &\textbf{0.0002} &0.0004 &0.0006 &0.0004 &0.2034 &\textbf{0.0002} &0.0012 &0.0005 &  \\
HyperplaneFaster0.2 &0.0272 &0.0088 &0.0118 &0.0016 &0.5671 &\textbf{0.0012} &0.0019 &0.0048 &0.0174 &0.0790 &0.0081 &0.0037 &0.0085 &  \\
...
SineGeneratorF2BF &0.0111 &0.0023 &0.0025 &0.0006 &0.1500 &\textbf{0.0003} &\textbf{0.0003} &0.0016 &0.0041 &0.0655 &0.0022 &0.0029 &0.0036 &  \\
...
RBFGradualRecurringCN0 &0.0438 &0.0133 &0.0135 &0.0058 &0.5329 &\textbf{0.0030} &0.0046 &0.0155 &0.0461 &0.2819 &0.0290 &0.0127 &0.0707 &  \\
RBFGradualRecurringACN0 &0.0437 &0.0155 &0.0155 &0.0571 &0.6604 &\textbf{0.0042} &0.0060 &0.0191 &0.0571 &0.3078 &0.0320 &0.0127 &0.0685 &  \\
HyperplaneFasterAN0 &0.0289 &0.0059 &0.0062 &0.0091 &0.2573 &\textbf{0.0010} &0.0012 &0.0034 &0.0117 &0.0546 &0.0067 &0.0040 &0.0151 &  \\
HyperplaneFasterAN5 &0.0290 &0.0058 &0.0059 &0.0091 &0.2602 &\textbf{0.0009} &0.0016 &0.0041 &0.0129 &0.0573 &0.0068 &0.0039 &0.0153 &  \\
HyperplaneFasterCN0 &0.0272 &5.8051 &0.0061 &0.0083 &877.2892 &0.3783 &\textbf{0.0016} &942.6669 &0.0127 &0.0557 &0.0061 &34.3009 &0.0153 &  \\
HyperplaneFasterACN0 &0.0272 &0.0100 &0.0103 &0.0110 &0.4614 &\textbf{0.0014} &0.0019 &0.0049 &0.0174 &0.0807 &0.0081 &0.0047 &0.0147 &  \\
...
CovTypeAN0 &0.0387 &0.0302 &0.0312 &0.0546 &1.1519 &0.0041 &\textbf{0.0010} &0.0292 &0.0529 &0.1946 &0.0362 &0.0241 &0.0649 &  \\
CovTypeCN0 &0.0389 &0.0173 &0.0175 &0.0317 &0.6655 &0.0026 &\textbf{0.0005} &0.0201 &0.0320 &0.1209 &0.0219 &0.0152 &0.0544 &  \\
CovTypeACN0 &0.0389 &0.0175 &0.0173 &0.0331 &0.6416 &0.0027 &\textbf{0.0005} &0.0222 &0.0315 &0.1211 &0.0215 &0.0155 &0.0550 &  \\
\noalign{\smallskip}\hline\noalign{\smallskip}
Average &0.0370 &0.1899 &0.0096 &0.0096 &28.0570 &0.0137 &\textbf{0.0030} &29.4697 &0.0248 &0.1704 &0.0166 &1.0802 &0.0278 &  \\
Rank &10.1250 &4.9688 &5.5000 &4.3281 &12.8750 &\textbf{1.8281} &2.5000 &6.8438 &8.9062 &11.8125 &6.8125 &5.4062 &9.0938 &  \\
\noalign{\smallskip}\hline\noalign{\smallskip}
\end{tabularx}}
\begin{minipage}{0.9\textwidth}
\centering
...
\coordinate (c0) at (10.125,0);
\coordinate (c1) at (4.9688,0);
\coordinate (c2) at (5.5,0);
\coordinate (c3) at (4.3281,0);
\coordinate (c4) at (12.875,0);
\coordinate (c5) at (1.8281,0);
\coordinate (c6) at (2.5,0);
\coordinate (c7) at (6.8438,0);
\coordinate (c8) at (8.9062,0);
\coordinate (c9) at (11.8125,0);
\coordinate (c10) at (6.8125,0);
\coordinate (c11) at (5.4062,0);
\coordinate (c12) at (9.0938,0);

\node (l0) at (c0) [above right=.1cm and 0cm, align=right,scale=0.7] {\tiny \textbf{OLLAWV}};
\node (l1) at (c1) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny HT};
\node (l2) at (c2) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny AdaHT};
\node (l3) at (c3) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny NaiveBayes};
\node (l4) at (c4) [below right=.1cm and 0cm, align=right,scale=0.7] {\tiny $k$NNPAW};
\node (l5) at (c5) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny SCD};
\node (l6) at (c6) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny RC};
\node (l7) at (c7) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny RCNB};
\node (l8) at (c8) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny SAE2};
\node (l9) at (c9) [below right=.1cm and 0cm, align=right,scale=0.7] {\tiny LearnNSE};
\node (l10) at (c10) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny DWM};
\node (l11) at (c11) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny DACC};
\node (l12) at (c12) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny OCBoost};

\fill[fill=gray,fill opacity=0.5] (1.8281,-0.1) rectangle (4.6171,0.1);
...
\end{tikzpicture}}\vspace{-1em}
\captionsetup{width=\linewidth}
\captionof{figure}{Bonferroni-Dunn test for Testing Time}\label{fig:BonfDunnTestDS}
\end{minipage}
\end{table}
...
\noalign{\smallskip}\hline\noalign{\smallskip}
accuracy &2.2031 &5.6562 &4.5000 &7.9531 &4.7031 &5.7500 &\textbf{11.2500} &6.7344 &8.1250 &8.7500 &6.9844 &10.9531 &7.4375 &  \\
kappa &2.5781 &5.7500 &4.5312 &7.7031 &4.7344 &5.6250 &\textbf{11.6562} &6.6094 &7.9688 &8.4688 &6.7344 &11.1406 &7.5000 &  \\
training time &6.5938 &4.9062 &5.6875 &3.4375 &6.9688 &6.2500 &9.2188 &9.2188 &8.2188 &\textbf{12.6875} &2.7188 &5.5000 &9.5938 &  \\
testing time &10.1250 &4.9688 &5.5000 &4.3281 &\textbf{12.8750} &1.8281 &2.5000 &6.8438 &8.9062 &11.8125 &6.8125 &5.4062 &9.0938 &  \\
\noalign{\smallskip}\hline\noalign{\smallskip}
Average &5.3750 &5.3203 &5.0547 &5.8555 &7.3203 &4.8633 &8.6562 &7.3516 &8.3047 &\textbf{10.4297} &5.8125 &8.2500 &8.4062 &  \\
Rank &5.0000 &4.0000 &\textbf{3.7500} &5.7500 &6.7500 &4.0000 &9.6250 &7.6250 &9.5000 &11.7500 &5.5000 &8.2500 &9.5000 &  \\
\noalign{\smallskip}\hline\noalign{\smallskip}
\end{tabularx}}
\begin{minipage}{0.9\textwidth}
\centering
...
\coordinate (c2) at (3.75,0);
\coordinate (c3) at (5.75,0);
\coordinate (c4) at (6.75,0);
\coordinate (c5) at (4,0);
\coordinate (c6) at (9.625,0);
\coordinate (c7) at (7.625,0);
\coordinate (c8) at (9.5,0);
\coordinate (c9) at (11.75,0);
\coordinate (c10) at (5.5,0);
\coordinate (c11) at (8.25,0);
\coordinate (c12) at (9.5,0);

\node (l0) at (c0) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny OLLAWV};
\node (l1) at (c1) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny HT};
\node (l2) at (c2) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny AdaHT};
\node (l3) at (c3) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny NaiveBayes};
\node (l4) at (c4) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny $k$NNPAW};
\node (l5) at (c5) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny SCD};
\node (l6) at (c6) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny RC};
\node (l7) at (c7) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny RCNB};
\node (l8) at (c8) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny SAE2};
\node (l9) at (c9) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny LearnNSE};
\node (l10) at (c10) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny DWM};
\node (l11) at (c11) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny DACC};
\node (l12) at (c12) [above left=.1cm and 0cm, align=right,scale=0.7] {\tiny OCBoost};

\fill[fill=gray,fill opacity=0.5] (3.75,-0.1) rectangle (6.539,0.1);
