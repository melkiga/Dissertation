...
\begin{algorithm}
\caption{List 2 L1-SVM}
\label{alg:List2L1SVM} 
\begin{algorithmic}[1]
\renewcommand{\algorithmicrequire}{\textbf{Input:}}
\renewcommand{\algorithmicensure}{\textbf{Output:}}
\Require $\bm X, \bm Y, C, \sigma, n, e, \beta$
\Ensure  $\bm \alpha$, $b$, $\bm I$
\State $\bm \alpha \leftarrow \bm 0,\, \bm o \leftarrow \bm 0,\, b \leftarrow 0,\, i \leftarrow 0$
\State $yo \leftarrow 0,\, max\_iter \leftarrow e*n,\, nsv \leftarrow 0$ 
\While{$i < max\_iter$}
\State $\eta \leftarrow \frac{2}{\sqrt{i}}$
\If{$yo \leq 1$}
\State $\lambda \leftarrow \eta\,C\,Y_i$, $\alpha_i \leftarrow \alpha_i + \lambda$, $b \leftarrow b + \lambda\,\beta$, $\bm I_{nsv} \leftarrow i$, $nsv \leftarrow nsv + 1$
\EndIf
\State $i \leftarrow i + 1$
\State $o_i \leftarrow \bm{K}(\bm x_i,\, \bm x_{\bm I})\, \bm \alpha_{\bm I} + b$
...
\begin{table}[t!]
\caption{Static Streamed Datasets}
\footnotesize
\centering
\label{tab:dsStaticDataset}
\begin{tabularx}{0.7\textwidth}{l@{\extracolsep{\fill}}rrr}
\hline\noalign{\smallskip}
Dataset & \# Samples & \# Attributes & \# Classes \\
\noalign{\smallskip}\hline\noalign{\smallskip}
spamCorpus	     & 	 9,324	     & 	39,917	         & 	2 \\
shuttle 	         		& 	 57,999	   & 	10	           & 	7 \\
powersupply	     	& 	 29,928	   & 	3	             & 	24 \\
poker-lsn 	       		& 	 829,201	   & 	11	           & 	10 \\
IntelLabSensors 	 & 	 2,313,153	 & 	6	             & 	58 \\
gasSensor 	     	& 	 13,910	   & 	129	           & 	1 \\
elecNormNew 	     & 	 45,312	   & 	9	             & 	2 \\
ecoli	           			& 	 336	     & 	8	             & 	8 \\
dj30	           			& 	 138,166	   & 	8	             & 	30 \\
covtypeNorm 	     & 	 581,012	   & 	55	           & 	7 \\
connect-4 	      		 & 	 67,557	   & 	43	           & 	3 \\
census 	         		& 	 299,284	   & 	42	           & 	2 \\
BNGzoo 	         & 	 1,000,000	 & 	18	           & 	7 \\
BNGwine 	       		& 	 1,000,000	 & 	14	           & 	3 \\
BNGlymph	       & 	 1,000,000	 & 	19	           & 	4 \\
BNGhypothyroid 	 & 	 1,000,000	 & 	30	           & 	4 \\
BNGhepatitis 	   & 	 1,000,000	 & 	20	           & 	2 \\
\noalign{\smallskip}\hline
\end{tabularx}
\end{table}

\begin{table}[t!]
\caption{Generator Datasets}
\footnotesize
\centering
\label{tab:dsgeneratorDataset}
