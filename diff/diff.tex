...
%DIF ADD ../dissertation.tex   Tue Jun 12 11:17:19 2018
\makeatletter
...
\DIFaddFL{Input Instance $i$ from Bag $I$ }& \DIFaddFL{$\bm{x}_i \in \reals^d,\, i \in I$ }\\
...
%DIF > Gradient Descent
%DIF > Subgradients
%DIF > Stochastic Gradient Descent

\subsection{\DIFadd{Issues with Current Online Learning Algorithms}}

\section{\DIFadd{OLLAWV: A Novel OnLine Learning Algorithm using Worst-Violators}}
